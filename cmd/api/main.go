...
import (
	...
	"example/myimdb/internal/data"
	"example/myimdb/internal/jsonlog"
	"example/myimdb/internal/mailer"
...
func main() {
	...
	// database
	flag.StringVar(&cfg.db.dsn,         "db-dsn",            os.Getenv("MYIMDB_DB_DSN"), "PostgreSQL DSN")
